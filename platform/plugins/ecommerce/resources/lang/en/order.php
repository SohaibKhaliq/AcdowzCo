...
return [
    ...
    'tracking_id_added' => 'Tracking ID :tracking_id has been added',
    'tracking_id_updated_from_to' => 'Tracking ID updated from :old to :new',
    'tracking_id_updated_successfully' => 'Tracking ID updated successfully',
    'current_tracking_id' => 'Current tracking ID',
    'track_shipment' => 'Track Shipment',
    'payment_method_cod' => 'Cash on Delivery (COD)',
    'payment_method_advance' => 'Pay Now',
    'cod_instructions' => 'Pay cash when you receive your order at your doorstep',
    'advance_payment_instructions' => 'Secure online payment via payment gateway',
];
